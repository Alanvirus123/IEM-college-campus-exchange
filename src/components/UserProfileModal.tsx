...
import { X, Mail, Phone, LogOut, CheckCircle, Edit3, ShieldCheck, User } from 'lucide-react';
            ...
            <>
              <div className="space-y-2.5">
                ...
                <div className="flex items-center gap-3 p-3 rounded-xl bg-gray-50 dark:bg-zinc-800/60 border border-gray-100 dark:border-zinc-800">
                  ...
                  <div className="text-left overflow-hidden">
                    <div className="text-[10px] text-gray-400 uppercase font-bold">Primary Phone / WhatsApp</div>
